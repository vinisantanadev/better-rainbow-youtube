...
#container.ytd-searchbox {
	border-top-left-radius: 1.6vh!important;
    border-bottom-left-radius: 1.6vh!important;
    border: none!important;
    background: transparent;
    box-shadow: none!important;
}
...
#search-icon-legacy {
	border-top-right-radius: 1.6vh!important;
    border-bottom-right-radius: 1.6vh!important;
    border: none;
